public class SingleModel extends Model {
    ...
    public SinglePlayer getCurrentPlayer() {

        return currentPlayer;
    }

    public void setCurrentPlayer(SinglePlayer player){
  ...
  public void toggleCurrentPlayer(){
    ...
    public boolean isWinLogic(Cell[][] cells) {
        ...
        if (cells[0][0].getIdent() == cells[0][1].getIdent() && cells[0][0].getIdent() == cells[0][2].getIdent() && cells[0][0].getIdent() != ' ') {
            result = true; // first row horizontal
        } else if (cells[1][0].getIdent() == cells[1][1].getIdent() && cells[1][0].getIdent() == cells[1][2].getIdent() && cells[1][0].getIdent() != ' ') {
            result = true; // 2nd row horizontal
        } else if (cells[2][0].getIdent() == cells[2][1].getIdent() && cells[2][0].getIdent() == cells[2][2].getIdent() && cells[2][0].getIdent() != ' ') {
            result = true; // 3rd row horizontal
        } else if (cells[0][0].getIdent() == cells[1][0].getIdent() && cells[0][0].getIdent() == cells[2][0].getIdent() && cells[0][0].getIdent() != ' ') {
            result = true; //first row vertical
        } else if (cells[0][1].getIdent() == cells[1][1].getIdent() && cells[0][1].getIdent() == cells[2][1].getIdent() && cells[0][1].getIdent() != ' ') {
            result = true; // 2nd row vertical
        } else if (cells[0][2].getIdent() == cells[1][2].getIdent() && cells[0][2].getIdent() == cells[2][2].getIdent() && cells[0][2].getIdent() != ' ') {
            result = true; //3rd row vertical
        } else if (cells[0][0].getIdent() == cells[1][1].getIdent() && cells[0][0].getIdent() == cells[2][2].getIdent() && cells[0][0].getIdent() != ' ') {
            result = true; //diagonal
        } else if (cells[0][2].getIdent() == cells[1][1].getIdent() && cells[0][2].getIdent() == cells[2][0].getIdent() && cells[0][2].getIdent() != ' ') {
            result = true; //diagonal
        }
        return result;
    }
